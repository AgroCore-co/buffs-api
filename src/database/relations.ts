...
import { bufalo, ciclolactacao, propriedade, alertas, usuario, coleta, industria, grupo, movlote, lote, dadoslactacao, estoqueleite, dadossanitarios, medicacoes, alimentacaodef, raca, materialgenetico, endereco, dadosreproducao, alimregistro, dadoszootecnicos, usuariopropriedade } from "./schema";
