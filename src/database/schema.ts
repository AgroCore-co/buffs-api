...
export const ciclolactacao = pgTable(
  ...
  (table) => [
    index('idx_ciclolactacao_deleted_at')
...
export const coleta = pgTable(
  'coleta',
  {
    idColeta: uuid('id_coleta')
      .default(sql`uuid_generate_v4()`)
      .primaryKey()
      .notNull(),
...
export const movlote = pgTable(
  'movlote',
  {
    idMovimento: uuid('id_movimento')
      .default(sql`uuid_generate_v4()`)
      .primaryKey()
      .notNull(),
...
export const dadoslactacao = pgTable(
  'dadoslactacao',
  {
    idLact: uuid('id_lact')
      .default(sql`uuid_generate_v4()`)
  ...
  (table) => [
    index('idx_dadoslactacao_deleted_at')
      .using('btree', table.deletedAt.asc().nullsLast().op('timestamptz_ops'))
      .where(sql`(deleted_at IS NULL)`),
    foreignKey({
      columns: [table.idBufala],
...
export const estoqueleite = pgTable(
  'estoqueleite',
  {
    idEstoque: uuid('id_estoque')
      .default(sql`uuid_generate_v4()`)
      .primaryKey()
      .notNull(),
    idPropriedade: uuid('id_propriedade'),
  ...
  (table) => [
    index('idx_estoqueleite_deleted_at')
      .using('btree', table.deletedAt.asc().nullsLast().op('timestamptz_ops'))
      .where(sql`(deleted_at IS NULL)`),
    foreignKey({
      columns: [table.idPropriedade],
...
export const dadossanitarios = pgTable(
  'dadossanitarios',
  {
    idSanit: uuid('id_sanit')
      .default(sql`uuid_generate_v4()`)
      .primaryKey()
      .notNull(),
  ...
  (table) => [
    index('idx_dadossanitarios_deleted_at')
      .using('btree', table.deletedAt.asc().nullsLast().op('timestamptz_ops'))
      .where(sql`(deleted_at IS NULL)`),
    foreignKey({
...
export const alimentacaodef = pgTable(
  'alimentacaodef',
  {
  ...
  (table) => [
    index('idx_alimentacaodef_deleted_at')
      .using('btree', table.deletedAt.asc().nullsLast().op('timestamptz_ops'))
      .where(sql`(deleted_at IS NULL)`),
    foreignKey({
      columns: [table.idPropriedade],
...
export const industria = pgTable(
  'industria',
  {
    idIndustria: uuid('id_industria')
      .default(sql`uuid_generate_v4()`)
  ...
  (table) => [
    index('idx_industria_deleted_at')
      .using('btree', table.deletedAt.asc().nullsLast().op('timestamptz_ops'))
      .where(sql`(deleted_at IS NULL)`),
    foreignKey({
      columns: [table.idPropriedade],
...
export const dadosreproducao = pgTable(
  'dadosreproducao',
  {
    idReproducao: uuid('id_reproducao')
      .default(sql`uuid_generate_v4()`)
      .primaryKey()
      .notNull(),
  ...
  (table) => [
    index('idx_dadosreproducao_deleted_at')
      .using('btree', table.deletedAt.asc().nullsLast().op('timestamptz_ops'))
      .where(sql`(deleted_at IS NULL)`),
    foreignKey({
      columns: [table.idBufala],
...
export const propriedade = pgTable(
  ...
  (table) => [
    index('idx_propriedade_deleted_at')
      .using('btree', table.deletedAt.asc().nullsLast().op('timestamptz_ops'))
      .where(sql`(deleted_at IS NULL)`),
    foreignKey({
...
export const alimregistro = pgTable(
  'alimregistro',
  {
  ...
  (table) => [
    index('idx_registroalimentacao_deleted_at')
      .using('btree', table.deletedAt.asc().nullsLast().op('timestamptz_ops'))
      .where(sql`(deleted_at IS NULL)`),
    foreignKey({
...
export const dadoszootecnicos = pgTable(
  'dadoszootecnicos',
  {
    idZootec: uuid('id_zootec')
      .default(sql`uuid_generate_v4()`)
      .primaryKey()
      .notNull(),
    idBufalo: uuid('id_bufalo'),
  ...
  (table) => [
    index('idx_dadoszootecnicos_deleted_at')
      .using('btree', table.deletedAt.asc().nullsLast().op('timestamptz_ops'))
      .where(sql`(deleted_at IS NULL)`),
    foreignKey({
      columns: [table.idBufalo],
...
export const medicacoes = pgTable(
  'medicacoes',
  {
    idMedicacao: uuid('id_medicacao')
      .default(sql`uuid_generate_v4()`)
      .primaryKey()
      .notNull(),
  ...
  (table) => [
    index('idx_medicacao_deleted_at')
      .using('btree', table.deletedAt.asc().nullsLast().op('timestamptz_ops'))
      .where(sql`(deleted_at IS NULL)`),
    foreignKey({
      columns: [table.idPropriedade],
...
export const materialgenetico = pgTable(
  'materialgenetico',
  {
    idMaterial: uuid('id_material')
      .default(sql`uuid_generate_v4()`)
      .primaryKey()
      .notNull(),
  ...
  (table) => [
    index('idx_materialgenetico_deleted_at')
      .using('btree', table.deletedAt.asc().nullsLast().op('timestamptz_ops'))
      .where(sql`(deleted_at IS NULL)`),
    foreignKey({
